...
from parax.utils.path import path_to_name
...
def iterate(
    ...
    *,
    ...
    path_and_nodes, _ = jax.tree.flatten_with_path(pytree, is_leaf=is_param)
...
def update(
    ...
    **param_kwargs: dict[str, Parameter] | dict[str, float],
    ...
    return jax.tree.map_with_path(map_fn, pytree, is_leaf=is_param)