# Vendored from gvcallen's distreqx fork (https://github.com/gvcallen/distreqx), Apache License 2.0.
# Source: distreqx/distributions/_independent.py
# Used when the installed distreqx's Independent does not take `reinterpreted_batch_ndims`.
